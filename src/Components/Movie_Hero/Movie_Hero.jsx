...
function Movie_Hero() {
    ...
    useEffect(() => {
        fetch("https://api.themoviedb.org/3/movie/popular?api_key=110d18c3a7a47b2f8739f8c719ff1aef&language=en-US")
            .then(res => res.json())
            .then((data) => {
                                ...
                                <div className="absolute bottom-9 left-4 w-full px-4 sm:px-6 lg:px-8">
                                    <div className="max-w-lg pb-3 lg:pb-3.4 relative z-10">
                                        <div className='mb-3 xl:mb-3.5'>
                                            <h1 className='text-white text-3xl font-bold'>{movie ? movie.original_title : ""}</h1>
                                        </div>
                                        <div>
                                            <div className="mb-3 xl:mb-3.5">
                                        ...
                                        <div
                                            className="mb-3 xl:mb-3.5 text-lg xl:text-xl text-white font-medium leading-[25px] xl:leading-7 hidden lg:block"
                                            style={{
                                                display: "-webkit-box",
