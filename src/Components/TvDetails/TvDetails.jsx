    ...
    return (
        <>
            <div className='min-h-screen bg-black p-3 md:p-6 flex justify-center items-center'>
                <div className='bg-gradient-to-t from-black/70 to-black/30 rounded-3xl md:p-8 max-w-7xl w-full text-white grid grid-cols-1 md:grid-cols-[1fr_3fr_1.5fr] gap-8 backdrop-blur-md shadow-xl'>
                    ...
                    <div className='flex flex-col space-y-4 font-sans'>
                        <div className='text-white text-xl md:text-2xl font-semibold'>
                            <h1 className='truncate'>{tv.name}</h1>
                        </div>
                    ...
                    <div className='flex justify-center items-start'>
                        <img src={`https://image.tmdb.org/t/p/w500${tv.poster_path}`} alt={tv.title} className="rounded-lg shadow-lg max-w-full h-auto object-cover" />
                    </div>
                </div>
            </div>
