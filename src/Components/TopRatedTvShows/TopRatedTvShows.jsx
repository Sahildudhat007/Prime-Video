...
const TMDB_URL = `https://api.themoviedb.org/3/tv/top_rated?api_key=${API_KEY}&language=en-US&page=1`;
        ...
        <>
            <section className='mb-9'>
                <div className='mx-6 md:mx-8 lg:mx-11 pb-2 lg:pb-3 flex items-center justify-between'>
                    <h2 className='text-[16px] md:text-lg xl:text-xl font-bold text-white'>Top Rated TV Shows</h2>
                </div>
                <div>
                            ...
                            {loading ? (
                                ...
                                topRatedTvShows.map((tv) => (
                                    <SwiperSlide key={tv.id} className="group relative text-white w-[280px] cursor-pointer">
                                        <Link to={`/tv/${tv.id}`}>
                                            <div className="bg-[#111] rounded-md overflow-hidden shadow-lg transition-transform duration-300 ease-in-out">
