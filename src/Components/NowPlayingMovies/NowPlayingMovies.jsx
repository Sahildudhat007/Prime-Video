...
const TMDB_URL = `https://api.themoviedb.org/3/movie/now_playing?api_key=${API_KEY}&language=en-US&page=1`;
        ...
        <>
            <section className='mb-9'>
                <div className='mx-6 md:mx-8 lg:mx-11 pb-2 lg:pb-3 flex items-center justify-between'>
                    <h2 className='text-[16px] md:text-lg xl:text-xl font-bold text-white'>Now Playing Movies</h2>
                </div>
                <div>
